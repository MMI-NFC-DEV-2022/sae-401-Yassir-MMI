<template><nav class="bg-black p-4">
    ...
    <div id="mobile-menu" class="md:hidden hidden">
      <div class="px-2 pt-2 pb-3 space-y-1 sm:px-3">
        ...
        <RouterLink to="/about" class="block text-white hover:text-gray-300">About</RouterLink>
        <RouterLink to="/films" class="block text-white hover:text-gray-300">Maisons</RouterLink>
        <RouterLink to="/films/edit" class="block text-white hover:text-gray-300">Créer des maisons</RouterLink>
